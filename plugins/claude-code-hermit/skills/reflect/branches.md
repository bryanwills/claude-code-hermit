...
- **No brief found (human/plugin or brief fully gone, moderate signal):** proceed via § Candidate processing as a plain Tier 2 improvement proposal (no `## Skill Improvement`). The candidate carries `Artifact: state/observations.jsonl`.
