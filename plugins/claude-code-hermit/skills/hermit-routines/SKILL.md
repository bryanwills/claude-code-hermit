...
- **Converting a costly broad-skill routine into a scoped one?** See [Routine Authoring](../../docs/routine-authoring.md) for the conversion checklist (scoped skill, haiku pin, verdict-line return, precheck gating).
