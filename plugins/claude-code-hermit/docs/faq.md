...
- **claude-code-hermit** = the base plugin package that provides task records, proposals, heartbeat, and the learning loop.
...
## When should I run `/claude-code-hermit:resident-start`?
