...
| `language` | string | `null` | Preferred language for responses. Auto-detected from locale. Also applies to script-composed channel messages (budget, denial, mint, watchdog, status), not just model replies. |
