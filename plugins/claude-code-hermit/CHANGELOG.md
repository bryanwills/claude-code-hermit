...
- **evaluate-session: progress nudge no longer backdates entries to the session start date** — same date-less-timestamp fix; the 48h "session may be complete" nudge now keys off SHELL.md mtime.
