...
- Watchdog routine-hygiene compaction now picks its `/compact` steering message by `session_state` at fire time: idle boundaries get a drop-completed-arc-detail message, mid-arc compacts keep the existing focus-on-unfinished-work message.
