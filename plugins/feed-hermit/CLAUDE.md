...
After install, run `/feed-hermit:hatch` in the target project. The core hermit (`claude-code-hermit` ≥1.2.53) must be installed and hatched first — `hatch` will prompt if it isn't.
