...
10. **HITL bash script.** Last resort. If a human must click, write a script that documents the exact steps and captures output so the loop is still structured.
...
*Adapted from [mattpocock/skills](https://github.com/mattpocock/skills) (MIT, Copyright 2026 Matt Pocock)*
