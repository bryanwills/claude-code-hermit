...
- `scripts/` — hook scripts; `scripts/lib/` — shared Node helpers (resolve-command, port-check, health-poll, log-watch-builder, shell-utils) with co-located `.test.js` runners
